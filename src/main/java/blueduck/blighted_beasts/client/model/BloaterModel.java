...
import blueduck.blighted_beasts.client.renderer.BloaterRenderState;
...
public class BloaterModel extends EntityModel<BloaterRenderState> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BlightedBeasts.MODID, "bloater"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        .texOffs(32, 0).addBox(-5.0F, 2.0F, -4.0F, 10.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -24.0F, 0.0F));
    ...
    public void setupAnim(BloaterRenderState state) {
        ...
        float f = state.swellProgress;
        float swellAmount = 1 + f * 0.5F;
        Body.xScale = swellAmount;
        Body.yScale = swellAmount;
        Body.zScale = swellAmount;
    }
