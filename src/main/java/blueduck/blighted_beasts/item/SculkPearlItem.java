package blueduck.blighted_beasts.item;
...
public class SculkPearlItem extends Item {
    public SculkPearlItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            SculkPearlProjectile thrownpearl = new SculkPearlProjectile(level, player, itemstack);
