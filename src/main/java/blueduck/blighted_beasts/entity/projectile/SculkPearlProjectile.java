...
public class SculkPearlProjectile extends ThrowableItemProjectile {
    ...
    public SculkPearlProjectile(Level level, LivingEntity owner, net.minecraft.world.item.ItemStack itemStack) {
        super(BlightEntities.SCULK_PEARL.get(), owner, level, itemStack);
    }

    public SculkPearlProjectile(Level level, double x, double y, double z, net.minecraft.world.item.ItemStack itemStack) {
        super(BlightEntities.SCULK_PEARL.get(), x, y, z, level, itemStack);
    }
